...
number_of_names_per_country = 47500
...
def get_matrix_from_name(name, abc_dict, suename_only=only_suename):
    matrix = []
...
for key in dict_chosen_names:
    ...
    #print("\n")
    for name in tqdm(dict_chosen_names[key], ncols=150):
...
with open("datasets/2_matrix_name_list.pickle",'wb') as o:
...
filepath = os.getcwd()+"/datasets/2_nationality_to_number_dict.json"
