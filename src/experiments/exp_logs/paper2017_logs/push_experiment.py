...
exp_log1 = "experiment1_bi_lstm/train_stats.json"
exp_log2 = "experiment2_lstm/train_stats.json"
exp_log3 = "experiment3_lstm_augm/train_stats.json"

post_run_push(exp_log2)