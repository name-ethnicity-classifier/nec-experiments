...
def create_dataloader(dataset_path: str="", test_size: float=0.01, val_size: float=0.01, batch_size: int=32, class_amount: int=10, shuffle: bool=False):
    ...
    train_set = NameEthnicityDataset(dataset=train_set, class_amount=class_amount)
