...
with open("datasets/preprocessed_datasets/final_more_matrix_name_list.pickle", "wb+") as o:
...
filepath = "datasets/preprocessed_datasets/final_more_nationality_to_number_dict.json"
with open(filepath, 'w+') as f:
    json.dump(names_countries_used, f)

#code to extract matrix name list from file again:
"""with open("datasets/preprocessed_datasets/final_english_matrix_name_list.pickle",'rb') as o:
