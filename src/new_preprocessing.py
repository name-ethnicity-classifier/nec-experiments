...
number_of_names_per_country = 50000
...
experimental = True
minimum_per_country = 10000
with open("datasets/more_dict_chosen_names.pickle",'rb') as o:
...
experimental_dict={'british':['british'],
                    ...
                    'french':['french'],
                    'chinese':['chinese'],
                    'else':['japanese', 'spanish', 'filipino', 'dutch', 'nigerian', 'south korean', 'taiwanese', 'hong konger','korean', 'swiss', 'danish', 'austrian','belgian', 'luxembourger', 'portugese',
...
for key in dict_chosen_names:
    ...
    try:
        ...
        for name in tqdm(list_of_names):
            ...
            # remove "dr", "ms", "mr", "mrs"
            if name.split(" ")[0] == "dr" or name.split(" ")[0] == "mr" or name.split(" ")[0] == "mr" or name.split(" ")[0] == "mrs":
...
with open("datasets/more_matrix_name_list.pickle",'wb') as o:
...
filepath = "datasets/more_nationality_to_number_dict.json"
